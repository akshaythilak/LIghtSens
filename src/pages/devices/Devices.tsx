...
const groupedTabs = {
  IOT: [
    { title: 'LCU', menulist: MenuList, outlinBtn: searchResetButtons, tableData: userData },
    {
      title: 'Concentrator',
      menulist: MenuList2,
  ...
  'Non-IOT': [
    ...
    { title: 'Light Pole', menulist: MenuList2, outlinBtn: searchResetButtons2 },
    { title: 'Lamps', menulist: MenuList2, outlinBtn: searchResetButtons, columns: userColumns2 },
  ],
};
  ...
  return (
    <React.Fragment>
      {/* <Box className="my-3 flex justify-between">
        ...
        />
        <ActionButtons buttons={resultsTabButtons} backgroundColor="#28367A" />
      </Box> */}
      <Box sx={{ height: '100%' }}>
